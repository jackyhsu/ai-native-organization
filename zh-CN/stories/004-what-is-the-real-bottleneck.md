# 004 当 AI 7×24 小时并行运行，什么才是公司的真正瓶颈？

[English](../../stories/004-what-is-the-real-bottleneck.md) | 中文

**作者：Jacky Hsu（许建志）**

## 当 AI 7×24 小时并行运行，什么才是公司的真正瓶颈？
...
这个阶段后来有了一个很形象的名字：Tokenmaxxing，尽可能把可用 Token 转换成工作量。对于刚刚经历过 002 那种生产力震撼的创业团队，它有极强的诱惑。昨天还因为没有工程师而焦虑，今天似乎已经拥有了一支随叫随到、永不休息的数字团队。
...
上一篇：[003 为什么传统层级跟不上 AI 的执行速度？](003-why-traditional-hierarchy-cannot-keep-up.md)
